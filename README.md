...
*   **[Индекс Шивы: ловушка простых праил на рке труда](https://habr.com/ru/articles/987274/)** - статья про новый индекс, Индекс Шивы *(написано о графиках и цифрах, а не о жизни, наверное поэтому статья провалилась - низкие охваты, низкий рейтинг)*
*   **[Театр продуктивности и страшный вопрос «Зачем?». «Виноваты зумеры — убийцы бизнеса](https://habr.com/ru/articles/1000756/)** - NLP анализ данных обернутый в проблему обвинения зумеров *(данные и графики докозательства и иллюстрации к рассуждениям о жизненной проблеме — охваты и рейтинг ещё хуже)* 
