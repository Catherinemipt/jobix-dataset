...
Так как изначально в датасете не было категоризации рисков, то они костыльным образом определялись по категориям и получали соответствующие веса. Усовершенствованный алгоритм больше этого не требует, но с полученным датасетом работать не удобно. Я устала терять файл - ключ, поэтому скину его сюда. 
Текстовым файл "category_mapping.jsonl" представляет из себя перечисление всех возможных флагов и присвоение ему определенной категории.
Встречаются 3 варианта:
`"риск"`: `"категория риска"`
`"риск"`: `"номер категории". "категория риска"`
`"риск"`: `"номер категории"`
Пример:
"Требование 'способность к рутинной работе'": "Стратегический хаос"
"Организационные риски из-за процесса найма": "2. Стратегический хаос"
"Манипуляция через KPI и доход": "2"


**Все категории с правильными номерами:**
1. Кризис управления
2. Стратегический хаос
3. Синдром Единорога
4. Junior Trap
5. Эксплуатация времени
6. Агрессивная экономия
7. Манипуляция лояльностью
8. Нереалистичный героизм
